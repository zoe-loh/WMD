...
void gen_points(double ini, double fin, int N, double *XXX);  // generates gauss partition
double integrate(double ini, double fin, int N, double *YYY); // integrates a function
